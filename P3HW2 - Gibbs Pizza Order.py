...
# Gibbs
# Eli
# pizza menu with all available toppings
available_pizzas = ['1', '1.5', '2', '3', '4']
available_toppings = ['1.5', '2', '3', '4']
...
order_pizza = True
while order_pizza:    
    print("Please enter how many pizzas you are ordering.: ")
    print()
    for pizzas in available_pizzas:
        print(pizzas)
        print()
    while True:
        pizza = input("How many pizzas would you like?")
